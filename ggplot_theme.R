...
theme_dt <- function(){
  theme_minimal() %+replace%
    ...
    axis.title.x = element_text(size = 15, colour = "darkseagreen1", family = "sans", margin = margin(0.5,0,0,0, "cm")),
    axis.title.y = element_text(size = 15, colour = "darkseagreen1", family = "sans", margin = margin(0,0.5,0,0, "cm"), angle = 90),
    ...
    legend.text           = element_text(colour = "darkseagreen1", size = 11, family = "serif"),
    legend.title          = element_text(colour = "darkseagreen1", size = 12, family = "sans", margin = margin(0, 0.1, 0, 0, "cm")),
    ...
    strip.text       = element_text(size = 11, colour = "darkseagreen1", family = "serif"),
    strip.text.y     = element_text(angle = -90),
    
    plot.background =  element_rect(fill = "darkslategray"),
    plot.title      =  element_text(size = 20, colour = "darkseagreen1", family = "sans", margin = margin(0,0,0.5,0, "cm")),
