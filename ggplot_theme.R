...
theme_dt <- function(){
  theme_minimal() %+replace%
    ...
    axis.title.x = element_text(size = 15, colour = "darkseagreen1", family = "sans", margin = ggplot2::margin(0.5,0,0,0, "cm")),
    axis.title.y = element_text(size = 15, colour = "darkseagreen1", family = "sans", margin = ggplot2::margin(0,0.5,0,0, "cm"), angle = 90),
    ...
    plot.title      =  element_text(size = 20, colour = "darkseagreen1", family = "sans", margin = ggplot2::margin(0,0,0.5,0, "cm")),
